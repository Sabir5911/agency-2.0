    ...
    return (
      <div className="flex flex-col items-start gap-1 justify-start text-left    font-roboto max-w-md">
       <p className={`max-w-sm text-sm text-muted-foreground`}> Pioneering Digital Revolution Since 2022</p>
        <h2 className="text-4xl/10 md:text-5xl font-bold mt-2 leading-snug" >
        ...
        <Link rel="canonical" href="https://calendly.com/sabirali786692/30min" className="mt-8">

        <CustomButton  text=" UNLOCK FREE SESSION" size="lg" variant="Blue" className=" px-6 py-3"/>
